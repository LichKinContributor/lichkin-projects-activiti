...
@RestController("SysActivitiProcessConfigU00Controller")
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysActivitiProcessConfig/U")
...
public class C extends LKApiBusUpdateController<I, SysActivitiProcessConfigEntity> {
	...
	@Override
	protected LKApiBusUpdateWithoutCheckerService<I, SysActivitiProcessConfigEntity> getService(I cin) {
		return service;
	}
