...
var activeTab = function(key) {
  if (key == null) {
    activeTab(serverDatas.tabName == 'pending' ? 'approval0form' : 'approval0process');
    return;
  }
...
var invoke_approval0process = function($content) {
  $('.button').hide();
};

var invoke_approval0form = function($content) {
