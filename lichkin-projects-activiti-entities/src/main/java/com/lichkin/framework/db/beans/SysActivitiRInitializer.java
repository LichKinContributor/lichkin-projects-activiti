...
class SysActivitiRInitializer implements LKRInitializer {
	...
	public static void init() {
		...
		LKDBResource.addColumn("70000004", "SysActivitiProcessConfigEntity", "platformType");
		LKDBResource.addColumn("70000005", "SysActivitiProcessConfigEntity", "processKey");
		LKDBResource.addColumn("70000006", "SysActivitiProcessConfigEntity", "processType");
		LKDBResource.addColumn("70000007", "SysActivitiProcessConfigEntity", "processCode");
		LKDBResource.addColumn("70000008", "SysActivitiProcessConfigEntity", "processName");
		LKDBResource.addColumn("70000009", "SysActivitiProcessConfigEntity", "deptId");
		LKDBResource.addColumn("70000010", "SysActivitiProcessConfigEntity", "stepCount");
		LKDBResource.addColumn("70000011", "SysActivitiProcessConfigEntity", "available");
		...
		LKDBResource.addColumn("70004011", "SysActivitiFormDataEntity", "stepCount");
		LKDBResource.addColumn("70004012", "SysActivitiFormDataEntity", "field1");
		LKDBResource.addColumn("70004013", "SysActivitiFormDataEntity", "field2");
		LKDBResource.addColumn("70004014", "SysActivitiFormDataEntity", "field3");
		LKDBResource.addColumn("70004015", "SysActivitiFormDataEntity", "field4");
		LKDBResource.addColumn("70004016", "SysActivitiFormDataEntity", "field5");
		LKDBResource.addColumn("70004017", "SysActivitiFormDataEntity", "field6");
		LKDBResource.addColumn("70004018", "SysActivitiFormDataEntity", "field7");
		LKDBResource.addColumn("70004019", "SysActivitiFormDataEntity", "field8");
		LKDBResource.addColumn("70004020", "SysActivitiFormDataEntity", "field9");
